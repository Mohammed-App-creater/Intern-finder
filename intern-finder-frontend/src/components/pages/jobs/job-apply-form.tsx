      ...
      <DialogContent className="max-w-md mx-auto bg-white rounded-lg shadow-xl max-h-[90vh] overflow-y-auto">
        <DialogHeader className="flex flex-row items-center justify-between p-6 pb-4">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-gradient-to-r from-blue-500 via-purple-500 to-green-500 rounded-full flex items-center justify-center">
              <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center">
                <div className="w-3 h-3 bg-gradient-to-r from-blue-500 via-purple-500 to-green-500 rounded-full"></div>
              </div>
            </div>
            <div>
              <DialogTitle className="text-lg font-semibold text-dark">{jobTitle}</DialogTitle>
          ...
          <Button variant="ghost" size="sm" onClick={onClose} className="h-8 w-8 p-0 hover:bg-gray-100">
            <X className="h-4 w-4 text-light" />
          </Button>
        </DialogHeader>

        <div className="px-6 pb-6">
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-dark mb-2">Submit your application</h3>
            <p className="text-sm text-light">The following is required and will only be shared with {companyName}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <Label htmlFor="previousTitle" className="text-sm font-medium text-dark">
            ...
            <div className="space-y-4">
              <h4 className="text-sm font-medium text-dark">LINKS</h4>

              <div>
                <Label htmlFor="linkedin" className="text-sm font-medium text-dark">
                  LinkedIn URL
                </Label>
                <Input
                  id="linkedin"
              ...
              <div>
                <Label htmlFor="portfolio" className="text-sm font-medium text-dark">
                  Portfolio URL
                </Label>
                <Input
                  id="portfolio"
            ...
            <div>
              <Label htmlFor="additionalInfo" className="text-sm font-medium text-dark">
            ...
            <div>
              <Label className="text-sm font-medium text-dark mb-2 block">Attach your resume</Label>
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                ...
                <Label htmlFor="resume" className="cursor-pointer flex flex-col items-center gap-2">
                  ...
                  <div>
                    <span className="text-sm font-medium text-primary">Attach Resume</span>
                    <span className="text-xs text-light block">or drag and drop</span>
                  </div>
                </Label>
                {formData.resume && <p className="text-xs text-dark mt-2">Selected: {formData.resume.name}</p>}
              </div>
            </div>
