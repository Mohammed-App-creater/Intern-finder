            ...
            <section>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-dark mt-2">
                    Designed mobile UI applications for Orange R&D department,
                    BNP Paribas, La Poste, Le Créd...
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-dark mt-2">
                    Designed print and web applications for Paul Breart,
                    Renault, Le théâtre du Marché, La mairie de Mantes la
                    Ville...
                  </p>
                </div>
              </div>
