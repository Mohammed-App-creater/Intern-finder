...
const testimonials = [
  {
    ...
    author: "Marco Kihn",
    role: "Happy Client",
    avatar: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRij6dtiHizH96qpCOe8WeXXP3yLyQJkPdGVg&s",
  },
  {
    id: 2,
